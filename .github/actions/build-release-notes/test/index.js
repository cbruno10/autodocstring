...
console.log("getNewModVersion - not production release, no current version");
result = getNewModVersion("1.0.0", "1.0.0-blah", "minor", "false");
console.log(result + "\n");

console.log("getNewModVersion - production release");
result = getNewModVersion("1.0.0", "1.0.0-blah", "minor", "true");
console.log(result + "\n");
